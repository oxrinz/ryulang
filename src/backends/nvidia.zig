...
// TODO: this should be compilekernel
pub fn compile(module: types.LLVMModuleRef, builder: types.LLVMBuilderRef, params: []*rir.RIROP) !void {
    ...
    // figure out the params, copy to device
...
pub fn genReturnFirstParam(module: types.LLVMModuleRef) !types.LLVMValueRef {
    return generateKernel(module, 2);
}
